// Godzilla Notifier Backend - v10 SIMPLE FRESH
...
app.get('/', (req, res) => res.json({
    name: 'Godzilla Notifier', version: '10 Simple Fresh',
    pool: pool.length,
    config: {
